...
PRODUCTS = [
    ...
    ("Bravecto Chewable Tablet Dogs > 9.9-22 lbs",  "Zoetis",  "Vet-only"),
    ("Bravecto Chewable Tablet Dogs > 22-44 lbs",   "Zoetis",  "Vet-only"),
    ("Bravecto Chewable Tablet Dogs > 44-88 lbs",   "Zoetis",  "Vet-only"),
    ("Bravecto Chewable Tablet Dogs > 88-123 lbs",  "Zoetis",  "Vet-only"),
