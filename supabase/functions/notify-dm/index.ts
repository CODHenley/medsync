    ...
    const html = `
      <div style="font-family:'DM Sans',Arial,sans-serif;max-width:480px;margin:0 auto;background:#fff;border-radius:12px;border:1px solid #EDE8F8;overflow:hidden;">
        ...
        <div style="padding:24px;">
          ...
          <p style="margin:0 0 16px;font-size:14px;color:#4A5568;"><strong>${sender_name}</strong> sent you a message on MedSync:</p>
          ...
          <a href="https://medsync.vet/medsync_portfolio_live.html" style="display:inline-block;background:#1C2B4A;color:#fff;text-decoration:none;padding:10px 20px;border-radius:8px;font-size:13px;font-weight:600;">Open MedSync</a>
        </div>
